...
<div class="h-full flex flex-col bg-white text-gray-900 shadow-sm border-l">
    <div class="flex border-b">
      <button class="px-4 py-2" :class="tab==='toolbox' ? 'bg-blue-500 text-white' : ''" @click="tab='toolbox'">Toolbox</button>
      <button class="px-4 py-2" :class="tab==='parameter' ? 'bg-blue-500 text-white' : ''" @click="tab='parameter'">Flow Parameter</button>
      <button class="px-4 py-2" :class="tab==='property' ? 'bg-blue-500 text-white' : ''" @click="tab='property'">Property</button>
    </div>
