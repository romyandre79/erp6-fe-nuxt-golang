    ...
    <template v-else>
      ...
      >
        ...
        <div class="absolute bottom-0 w-full p-4 border-t border-gray-100">
          <button
            class="flex items-center w-full px-4 py-2 text-gray-600 hover:bg-red-50 hover:text-red-600 rounded-lg transition-colors"
          >
            <svg
              class="w-5 h-5"
              :class="sidebarOpen ? 'mr-3' : 'mx-auto'"
        ...
        <header class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6 sticky top-0 z-10">
          ...
          <div class="flex items-center gap-4">
            <div class="flex items-center gap-3">
              ...
              <div
                class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 overflow-hidden"
              >
