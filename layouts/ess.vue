<template>
  <div class="min-h-screen bg-gray-50 flex font-sans">
    <!-- Sidebar -->
    <aside
      class="w-64 bg-slate-900 text-white hidden md:flex flex-col flex-shrink-0 transition-all duration-300 shadow-xl z-20"
    >
      <div class="h-16 flex items-center px-6 bg-slate-950 border-b border-slate-800">
        <h1 class="text-lg font-bold tracking-wider text-blue-400">ESS PORTAL</h1>
      </div>
      ...
      <div class="p-4 border-b border-slate-800 flex items-center space-x-3">
        ...
        <div>
          ...
          <div class="text-xs text-slate-400">ID: 100293</div>
        </div>
      </div>
      ...
      <nav class="flex-1 mt-6 px-3 space-y-1">
        <NuxtLink
          to="/ess/dashboard"
          class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition-all group"
        ...
        >
          ...
          <span class="font-medium">Sick Report</span>
        </NuxtLink>
      </nav>
      ...
      <div class="p-4 border-t border-slate-800">
        <NuxtLink
          to="/ess"
          class="flex items-center space-x-3 px-3 py-2 text-slate-400 hover:text-white transition-colors"
        >
    ...
    <div class="flex-1 flex flex-col min-w-0 bg-slate-50">
      ...
      <header class="bg-white shadow-sm h-16 flex items-center justify-between px-6 md:hidden z-10">
        <div class="font-bold text-slate-800">ESS PORTAL</div>
