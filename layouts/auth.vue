...
<template>
  <ClientOnly>
    <UApp>
      <div
        class="admin-layout flex h-screen overflow-hidden transition-colors duration-300"
        style="background: var(--content-background, #f8fafc)"
      >
        <!-- MODERN SIDEBAR -->
        <aside
          :class="[
        ...
        >
          ...
          <div class="flex items-center h-16 px-4" style="border-bottom: 1px solid var(--sidebar-border-color)">
            <div v-if="!isCollapsed" class="flex items-center gap-3 flex-1">
              <div
                class="w-9 h-9 flex items-center justify-center shadow-lg"
                style="
                  border-radius: var(--sidebar-radius);
                  background: var(--sidebar-logo-background, linear-gradient(135deg, #6366f1, #9333ea));
                "
              >
          ...
          <button
            ...
            style="
              border-radius: var(--sidebar-collapse-radius);
              background: var(--sidebar-collapse-background);
              color: var(--sidebar-collapse-color);
              z-index: 50;
            "
          >
          ...
          <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1 custom-scrollbar">
            <div v-for="parent in parentMenus" :key="parent.menuaccessid" class="mb-1">
              ...
              >
                ...
                <!-- Label -->
                <span v-if="!isCollapsed" class="menu-label flex-1 text-left text-sm font-medium capitalize truncate">
              ...
              <transition name="slide-fade">
                ...
                >
                  ...
                  >
                    <UIcon
                      v-if="isNuxtIcon(child.menuicon)"
                      :name="child.menuicon"
                      class="text-[11px] opacity-70 w-4"
                    />
          ...
          <div class="p-3" style="border-top: 1px solid var(--sidebar-border-color)">
            ...
            >
              ...
              <div
                ...
                style="color: var(--sidebar-profile-icon-color)"
              >
