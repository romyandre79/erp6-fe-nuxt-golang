...
const orders = [
  ...
  { id: 'ORD-2024-004', date: '2024-11-28', total: '$3,200.00', status: 'Delivered', items: 'Conference Room Furniture' },
  ...
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      ...
      <div class="flex gap-2">
         <input type="text" placeholder="Search orders..." class="border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      <div class="p-4 border-t border-gray-100 flex justify-between items-center">
        ...
        <div class="flex gap-2">
            <button class="px-3 py-1 border border-gray-300 rounded hover:bg-gray-50 text-sm disabled:opacity-50" disabled>Previous</button>
