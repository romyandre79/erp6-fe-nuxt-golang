  ...
  <div class="min-h-screen flex flex-col">
    ...
    <main class="flex-grow pt-24 pb-20 px-4 relative">
      ...
      <div v-else-if="pageData" class="mx-auto w-full">
        ...
        <FormRender v-if="pageData.menuform" :schema="pageData.menuform" formType="public" />
        <div v-else class="text-center text-gray-400 py-20">This page has no content defined.</div>
      </div>
    </main>
